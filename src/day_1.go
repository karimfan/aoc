...
func part_one(inputFilePath string) {
...
func part_two(inputFilePath string) {
...
func main() {
	inputFilePath := flag.String("input", "../input/day_1.txt", "Path of file to be processed")

	part_one(*inputFilePath)
	part_two(*inputFilePath)
}
